		...
		initSlickCarousel: function () {
			...
			this.collection.each(function (i, el) {
				...
				$this.on('init', function (event, slick) {
					...
					if ($(slick.$slider).attr("id")==="sliderSyncingNav"){
						$(".slick-goto").each((index,target)=>{
							const slickGotoElement = $(target);
							const slides = $(slick.$slides);
							slides.each((index,slideTarget)=>{
								const slideElement = $(slideTarget);
								if (slickGotoElement.find("img").attr("src")===slideElement.find("img").attr("src")){
									slickGotoElement.attr("slickindex",slideElement.data("slick-index"))
								}
							})
						})
						$(".slick-goto").click((e)=>{
							e.preventDefault();
							e.stopPropagation();
							const index = $(e.currentTarget).attr("slickindex");
							$(slick.$slider).slick("slickGoTo",parseInt(index));
						})
					}
				...
				$this.on('afterChange', function (event, slick, currentSlide) {
					var slide = $(slick.$slides)[currentSlide],
						animatedElements = $(slide).find('[data-scs-animation-in]');
						$(document.body).trigger("onLazyLoadProductImage");
					$(animatedElements).each(function () {
						var animationIn = $(this).data('scs-animation-in'),
							animationDelay = $(this).data('scs-animation-delay'),
							animationDuration = $(this).data('scs-animation-duration');
